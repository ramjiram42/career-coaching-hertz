...
// Static mock data — DB replaced with hardcoded values for Vercel deployment
const MODULES = [
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              ...
              <p style={{ color: '#6B7280', fontSize: '0.95rem' }}>
                <span style={{ background: '#F1F5F9', padding: '0.2rem 0.75rem', borderRadius: 999, fontWeight: 700, color: '#374151', marginRight: '0.5rem', fontSize: '0.8rem' }}>Branch Manager / Operations</span>
                →
                <span style={{ background: '#FFFBEB', padding: '0.2rem 0.75rem', borderRadius: 999, fontWeight: 700, color: '#92400E', marginLeft: '0.5rem', fontSize: '0.8rem' }}>Regional Operations Director</span>
              </p>
            </div>
            <div style={{ textAlign: 'right' }}>
              <div style={{ fontSize: '3.5rem', fontWeight: 900, color: '#FFD100', letterSpacing: '-0.04em', lineHeight: 1 }}>{readinessScore}%</div>
              <p style={{ fontSize: '0.7rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.15em', color: '#9CA3AF', marginTop: '0.25rem' }}>Readiness Score</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.25rem', marginBottom: '2.5rem' }}>
          ...
          <div className="card">
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
              ...
              <span style={{ fontWeight: 800, fontSize: '0.9rem', color: '#000' }}>Timeline</span>
            </div>
            <p style={{ fontWeight: 900, fontSize: '2rem', color: '#000', letterSpacing: '-0.04em', lineHeight: 1 }}>~4 Mo.</p>
            <p style={{ marginTop: '0.25rem', fontSize: '0.8rem', color: '#9CA3AF' }}>At 10 hours/week study pace</p>
          </div>
        </div>
