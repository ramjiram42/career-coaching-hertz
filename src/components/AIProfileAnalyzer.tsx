...
export function AIProfileAnalyzer() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fff', width: '100%', paddingBottom: 100, overflowX: 'hidden' }}>
      ...
      {/* FINAL FULL WIDTH HERTZ BANNER - REDUCED SIZE */}
      <div style={{ 
        width: '100%', 
        position: 'relative', 
        height: 240, 
        ...
        borderBottom: '4px solid #FFD100' 
         ...
         <div style={{ width: '100%', maxWidth: 1400, margin: '0 auto', padding: '0 60px', position: 'relative', zIndex: 10, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            {/* Profile Card Overlay (REDUCED SIZE) */}
            <div style={{ background: 'rgba(255,255,255,0.98)', borderRadius: 20, padding: '20px 28px', display: 'flex', alignItems: 'center', gap: 20, boxShadow: '0 20px 40px rgba(0,0,0,0.3)', border: '1px solid #E2E8F0' }}>
               <div>
                  <p style={{ fontSize: 20, fontWeight: 950, color: '#000', margin: 0 }}>Ram</p>
                  <p style={{ fontSize: 13, color: '#4B5563', margin: '2px 0', fontWeight: 700 }}>Your profile is looking awesome</p>
               ...
               <div style={{ width: 68, height: 68, borderRadius: '50%', overflow: 'hidden', border: '4px solid #F1F5F9' }}>
